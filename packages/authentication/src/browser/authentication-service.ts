...
export class AuthenticationService implements Disposable, AuthenticationService {
    ...
    // this._register(new Emitter<{ providerId: string, event: AuthenticationSessionsChangeEvent }>());
